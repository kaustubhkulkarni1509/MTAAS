...
handleOnSubmit = async (e) => {
  ...
  try {
      ...
      const res = await axios.post('http://localhost:4001/updatemanagerprofile', user)
      console.log(res)
...
async componentWillMount() {
  ...
  const user_profile = await axios.post('http://localhost:4001/getmanagerprofile', user_json)
